    ...
    <div className="min-h-screen bg-background text-foreground">
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        <div className="prose prose-invert max-w-none">
          <h1 className="text-4xl font-heading my-8 text-primary">
            Privacy Policy
          </h1>
          ...
          <div className="space-y-8 text-muted-foreground leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-heading mb-4 text-accent">1. Scope</h2>
            ...
            <section>
              <h2 className="text-2xl font-heading mb-4 text-accent">2. Information We Collect</h2>
              <div className="overflow-x-auto">
                <table className="w-full border-collapse border border-border/60 mb-4">
                  <thead>
                    <tr className="bg-background/80">
                      <th className="border border-border/60 p-3 text-left text-primary">Category</th>
                      <th className="border border-border/60 p-3 text-left text-primary">What It Includes</th>
                      <th className="border border-border/60 p-3 text-left text-primary">How We Collect</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      <td className="border border-border/60 p-3 font-subheading">Contact details</td>
                      <td className="border border-border/60 p-3">Name, email, phone, company, message content</td>
                      <td className="border border-border/60 p-3">When you submit a contact form or email us</td>
                    </tr>
                    <tr className="bg-background/70">
                      <td className="border border-border/60 p-3 font-subheading">Billing & project data</td>
                      <td className="border border-border/60 p-3">Billing address, invoice IDs, payment status, project specifications, <em>client‑supplied media assets (e.g., video clips, images)</em></td>
                      <td className="border border-border/60 p-3">When you become a client or request a quote</td>
                    </tr>
                    <tr>
                      <td className="border border-border/60 p-3 font-subheading">Technical/usage data</td>
                      <td className="border border-border/60 p-3">IP address (anonymized in GA4), browser type, device ID, pages visited, timestamps</td>
                      <td className="border border-border/60 p-3">Automatically via first‑party cookies, server logs, Google Analytics 4</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <section>
              <h2 className="text-2xl font-heading mb-4 text-accent">3. How We Use Information</h2>
            ...
            <section>
              <h2 className="text-2xl font-heading mb-4 text-accent">4. Legal Bases for Future International Compliance</h2>
            ...
            <section>
              <h2 className="text-2xl font-heading mb-4 text-accent">5. Sharing & Disclosure</h2>
            ...
            <section>
              <h2 className="text-2xl font-heading mb-4 text-accent">6. Cookies & Tracking</h2>
            ...
            <section>
              <h2 className="text-2xl font-heading mb-4 text-accent">7. Your Choices & Rights</h2>
              <ul className="list-disc pl-6 space-y-3">
                <li><strong>Email opt‑out:</strong> Every outreach email contains a clear unsubscribe option. You may also email <a href="mailto:privacy@moonsoutmedia.com" className="text-primary hover:text-accent transition-colors">privacy@moonsoutmedia.com</a> with &quot;unsubscribe.&quot; Requests are honored within 10 business days and the address is placed on our suppression list.</li>
                <li><strong>Access, correct, or delete:</strong> Contact us (email or <a href="/contact" className="text-primary hover:text-accent transition-colors">request form</a>) and we will respond to verifiable requests as required by applicable U.S. law.</li>
                <li><strong>Cookies:</strong> Use your browser controls to block or delete cookies at any time.</li>
              </ul>
              
              <div className="bg-background/80 p-4 rounded-lg border border-primary/30 mt-4">
                <p>Exercising any of these rights will <strong>not</strong> result in discriminatory treatment.</p>
              </div>
            </section>

            <section>
              <h2 className="text-2xl font-heading mb-4 text-accent">8. Data Security</h2>
            ...
            <section>
              <h2 className="text-2xl font-heading mb-4 text-accent">9. Retention</h2>
              <ul className="list-disc pl-6 space-y-2">
            ...
            <section>
              <h2 className="text-2xl font-heading mb-4 text-accent">10. Children&apos;s Privacy</h2>
            ...
            <section>
              <h2 className="text-2xl font-heading mb-4 text-accent">11. Changes to This Policy</h2>
            ...
            <section>
              <h2 className="text-2xl font-heading mb-4 text-accent">12. Contact Us</h2>
              <div className="bg-background/80 p-4 rounded-lg border border-primary/30">
                <p><strong>Moons Out Media</strong><br />
                United States Corporation Agents, Inc.<br />
                1991 Crocker Road &#35;600‑755<br />
                Westlake, OH 44145<br />
                Email: <a href="mailto:team@moonsoutmedia.com" className="text-primary hover:text-accent transition-colors">team@moonsoutmedia.com</a><br />
                Phone: <strong>(937) 451‑0042</strong></p>
              </div>
            </section>

            <div className="bg-background/70 p-4 rounded-lg border border-border/60 mt-8 text-body-sm italic">
