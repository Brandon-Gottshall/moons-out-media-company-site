...
export default function PortfolioItemPage({
  ...
  useEffect(() => {
    if (currentItem) {
      const availableTabs = [];
      if (currentItem.challenge || currentItem.solution)
        availableTabs.push("challenge");
      if (currentItem.results) availableTabs.push("results");
      if (currentItem.galleryImages && currentItem.galleryImages.length > 0)
        availableTabs.push("gallery");
      if (validShowcaseVideos.length > 0) availableTabs.push("videos");
