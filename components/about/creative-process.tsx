...
export default function CreativeProcess() {
  ...
  return (
    <section className="py-16">
      ...
      >
        <h2 className="text-4xl font-heading mb-16 text-center text-primary">
        ...
        <div ref={containerRef} className="relative max-w-4xl mx-auto">
          {/* Progress Line */}
          <div className="absolute left-8 md:left-16 top-0 bottom-0 w-1 bg-border/60 hidden md:block"></div>
          <motion.div
          ...
          <motion.div
            className="absolute left-8 md:left-16 w-3 h-3 rounded-full bg-primary hidden md:block z-20"
            style={{
          ...
          <div className="space-y-16 md:space-y-28">
            {processSteps.map((step, index) => (
              ...
              >
                <div className="flex-shrink-0 w-16 h-16 md:w-32 md:h-32 rounded-full bg-background flex items-center justify-center z-10 border border-primary/20 relative">
                  {/* Pulsing ring effect */}
                  <motion.div
                ...
                <div className="flex-1 bg-background/80 backdrop-blur-sm border border-border/60 rounded-lg p-6 md:p-8 relative overflow-hidden">

                  <div className="flex items-center mb-4 md:mb-6 relative z-10">
                    <div className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-secondary flex items-center justify-center mr-4">
                      <span className="md:text-body-lg text-foreground font-heading">
                        {step.id}
                      </span>
                    </div>
                    <h3 className="text-heading-md md:text-2xl font-heading text-foreground">
                      {step.title}
                    </h3>
                  </div>
                  <div className="bg-background/60 p-4 rounded-lg relative z-10 border border-border/40">
        ...
        >
          <div className="bg-background/80 border border-border/60 rounded-lg p-6">
            <h3 className="text-2xl font-heading mb-6 text-center text-primary">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center p-4">
                ...
                <h4 className="text-body-lg font-heading mb-2">
