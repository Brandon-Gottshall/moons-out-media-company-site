    ...
    return (
      <div className="w-full h-full relative group overflow-hidden rounded-lg">
        ...
        <div className="absolute bottom-0 left-0 right-0 bg-black/70 p-2 z-10">
          <h3 className="text-body-sm font-heading text-white leading-tight">Sustainable Innovation</h3>
          <p className="text-label-base text-cyberpunk-blue">EcoTech Innovations</p>
        </div>
        ...
        <div className="absolute bottom-0 left-0 right-0 bg-black/90 p-3 transform translate-y-full group-hover:translate-y-0 transition-transform duration-300 z-20">
          <p className="text-label-base text-white">
    ...
    >
      ...
      <div className="p-4 md:p-6">
        <div className="flex flex-wrap justify-between items-start gap-3 mb-4">
          <div>
            <span className="inline-block px-3 py-0.5 rounded-full text-label-base font-emphasis bg-cyberpunk-blue/20 text-cyberpunk-blue mb-2">
              Documentary Series
            </span>
            <h3 className="text-body-lg md:text-heading-md lg:text-2xl font-heading text-white mb-1 whitespace-nowrap overflow-hidden text-overflow-ellipsis leading-tight">
              Sustainable Innovation Documentary
            </h3>
            <p className="text-cyberpunk-pink ">Client: EcoTech Innovations</p>
          </div>

          <div className="flex flex-wrap gap-3">
            <span className="px-3 py-1 bg-black/50 rounded-md text-body-sm text-white">4K</span>
            <span className="px-3 py-1 bg-black/50 rounded-md text-body-sm text-white">5-Part Series</span>
            <span className="px-3 py-1 bg-black/50 rounded-md text-body-sm text-white">2023</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-4">
          <div className="bg-black/50 p-3 rounded-lg text-center">
            <p className="text-2xl font-heading text-white mb-0">87%</p>
            <p className="text-body-sm text-white mb-0">Brand Awareness</p>
            <p className="text-label-base text-cyberpunk-green">+42%</p>
          </div>
          <div className="bg-black/50 p-3 rounded-lg text-center">
            <p className="text-2xl font-heading text-white mb-0">$12M</p>
            <p className="text-body-sm text-white mb-0">Investor Interest</p>
            <p className="text-label-base text-cyberpunk-green">+156%</p>
          </div>
          <div className="bg-black/50 p-3 rounded-lg text-center">
            <p className="text-2xl font-heading text-white mb-0">14</p>
            <p className="text-body-sm text-white mb-0">New Partnerships</p>
            <p className="text-label-base text-cyberpunk-green">+250%</p>
          </div>
        </div>

        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Button
            className="cyberpunk-button py-3 text-body-sm"
            onClick={(e) => { 
              if (!isCardLinkDisabled) e.stopPropagation();
          ...
          <Button
            variant="outline"
            className="border-cyberpunk-blue text-cyberpunk-blue hover:bg-cyberpunk-blue/10 p-3 text-body-sm"
            onClick={(e) => { 
              if (!isCardLinkDisabled) e.stopPropagation();
