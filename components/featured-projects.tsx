  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <div className="space-y-4">
        <h3 className="text-xl font-bold text-white mb-4 tracking-wide">Featured Projects</h3>
        ...
        {projects.map((project) => (
          ...
          >
            <div className="flex items-center">
              ...
              <div>
                <h4 className={`font-medium ${activeProject.id === project.id ? "text-white" : "text-gray-300"}`}>
                  {project.title}
                </h4>
                <p className={`text-sm ${activeProject.id === project.id ? "text-cyberpunk-blue" : "text-gray-500"}`}>
                  {project.client}
                </p>
              </div>
        ...
        <Button
          variant="outline"
          className="w-full border-cyberpunk-pink text-cyberpunk-pink hover:bg-cyberpunk-pink/10 mt-4 font-bold shadow-glow-pink"
