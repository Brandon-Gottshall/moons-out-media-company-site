      ...
      <div className="container mx-auto text-center relative z-10">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-white">
            Ready to{" "}
            <span className="text-cyberpunk-pink">Tell Your Story</span>?
          </h2>
          <div className="bg-black/60 backdrop-blur-sm p-6 rounded-lg border border-cyberpunk-blue/20 max-w-2xl mx-auto mb-8">
            <p className="text-xl text-gray-200">
              Ready to tell your story and power it with tech? Let’s create
              cinematic documentaries and tailored web/AI solutions for your
              brand.
            </p>
          </div>
          <motion.div
