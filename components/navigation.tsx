...
export default function Navigation({ logoSlot }: NavigationProps) {
  ...
  const calculateAnimationDuration = (hoveredIndex: number | null) => {
    ...
    const distance = Math.abs(
      (hoveredIndex !== -1 ? hoveredIndex : 0) - currentPageIndex
    );
  ...
  const getActivePosition = () => {
    const index =
      lastHoveredIndex !== null ? lastHoveredIndex : currentPageIndex;
      ...
      <div className="container mx-auto px-4 flex justify-between items-center w-full">
        {logoSlot || (
          <Link href="/" className="flex items-center">
            ...
            >
              <span className="text-cyberpunk-blue mr-1 tracking-wider">
                MOONS
              </span>
          ...
          <nav
            ...
            onMouseLeave={() => {
              ...
              setAnimationDuration(
                calculateAnimationDuration(lastHoveredIndex)
              );
            }}
          >
            ...
            >
              ...
              <motion.div
                ...
                animate={{
                  left:
                    getActivePosition().left - (trackPositions[0]?.left || 0),
                  ...
                  >
                    <Link
                      ...
                      className={cn(
                        ...
                        isActive
                          ? "text-cyberpunk-pink"
                          : "text-white hover:text-cyberpunk-blue"
                      )}
